  ...
  return (
    <section id='projects' className='p-10 text-center'>
        ...
        <div className='grid md:grid-cols-2 gap-4 mt-4'>
            ...
            <div className='p-4 bg-blue-900 rounded w-full text-white hover:bg-amber-300 hover:text-blue-700'><Link href="https://devhub-liart.vercel.app/">Devhub</Link></div>
            <div className='p-4 bg-blue-900 rounded w-full text-white hover:bg-amber-300 hover:text-blue-700'><Link href="https://bookings-tawny.vercel.app/">Booking App</Link></div>
